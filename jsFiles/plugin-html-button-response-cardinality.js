var jsPsychHtmlButtonResponseCardinality = (function (jspsych) {
  'use strict';
   ...
   */
  class HtmlButtonResponseCardinalityPlugin {
      constructor(jsPsych) {
      ...
      trial(display_element, trial) {
          ...
          html += '<div id="jspsych-html-button-response-btngroup-cardinality">';
          for (var i = 0; i < trial.choices.length; i++) {
  ...
  HtmlButtonResponseCardinalityPlugin.info = info;

  return HtmlButtonResponseCardinalityPlugin;
